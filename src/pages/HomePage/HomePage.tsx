  ...
  return (
    <div className="w-full bg-[#0A0F1F] text-white">
      <section className="relative overflow-hidden">
        <div aria-hidden className="absolute inset-0 -z-10 bg-[radial-gradient(1200px_720px_at_86%_12%,rgba(88,40,211,0.35),transparent_60%)]" />
        <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 pt-12 pb-12 md:grid-cols-[1.08fr_0.92fr] lg:px-6">
          <div className="relative">
            <div aria-hidden className="pointer-events-none absolute -left-40 -top-40 md:-left-64 md:-top-56 h-[36rem] w-[36rem] md:h-[46rem] md:w-[46rem] rounded-full -z-10 bg-[radial-gradient(closest-side_at_50%_50%,rgba(139,92,246,0.92),rgba(88,40,211,0.58)_56%,transparent_72%)]" />
            ...
            <p className="mt-6 max-w-[560px] text-[15px] text-white/90">Utmana dina vänner i kunskap – börja gratis redan idag.</p>
            <div className="mt-6 w-full">
              <div className="mx-auto flex w-fit flex-wrap items-center justify-center gap-4">
                <Link to="/register" className="inline-flex items-center justify-center rounded-xl bg-[#22C55E] px-6 py-3 text-[14px] font-semibold text-white shadow-[0_12px_28px_rgba(34,197,94,0.35)] hover:brightness-110 active:scale-[0.99]">Registrera dig</Link>
                <Link to="/login" className="inline-flex items-center justify-center rounded-xl bg-[#4F2ACB] px-6 py-3 text-[14px] font-semibold text-white/95 shadow-[0_12px_28px_rgba(79,42,203,0.45)] hover:brightness-110 active:scale-[0.99]">Logga in</Link>
              </div>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="relative mx-auto w-full max-w-[560px] rounded-[26px] bg-[#0F1426] p-5 ring-1 ring-white/10 shadow-[0_25px_80px_rgba(124,76,255,0.25),0_0_0_1px_rgba(0,0,0,0.25)]">
              <img src={groupImg} alt="Frågefejden - vänner som quiz:ar" className="h-auto w-full rounded-2xl" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <article className="rounded-2xl border border-[#2A3353] bg-[#0F1A2F]/90 shadow-[0_10px_26px_rgba(0,0,0,0.25)]">
            ...
            <div className="px-6 pb-6">
              <div className="rounded-xl bg-[#202A49]/60 px-4 py-4 text-[14.5px] leading-relaxed text-white/90">”Frågefejden gör lärandet roligare! Samla poäng, utmana dina vänner och klättra på topplistan – samtidigt som du lär dig mer i skolan.”</div>
            </div>
          </article>
          ...
          <article className="rounded-2xl border border-[#2A3353] bg-[#0F1A2F]/90 shadow-[0_10px_26px_rgba(0,0,0,0.25)]">
            ...
            <div className="px-6 pb-6">
              <div className="rounded-xl bg-[#202A49]/60 px-4 py-4 text-[14.5px] leading-relaxed text-white/90">”Frågefejden – lärande på ett nytt sätt. Följ elevers utveckling, skapa quiz och testa deras kunskaper digitalt. Ett engagerande och roligt verktyg för klassrummet.”</div>
            </div>
          </article>
        </div>
      </section>
